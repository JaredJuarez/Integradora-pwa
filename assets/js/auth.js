...
function logout() {
    confirmAction('¿Estás seguro que deseas cerrar sesión?', () => {
        ...
        setTimeout(() => {
            ...
            if (currentPath.includes('/pages/admin/') || currentPath.includes('/pages/cliente/') || currentPath.includes('/pages/empleado/')) {
...
function updateUserInfo() {
    ...
    if (userRoleElement) userRoleElement.textContent = Format.capitalize(user.rol);
