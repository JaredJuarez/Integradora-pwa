...
const DEMO_ORDERS = [
    {
        ...
        productos: [
            { productoId: 1, nombre: 'Laptop Dell XPS 15', cantidad: 1, precio: 28999.99 }
        ],
        total: 28999.99,
        estado: 'entregado',
        fecha: '2025-01-10',
        direccion: 'Av. Universidad 123, Cuernavaca, Morelos'
    },
    {
        id: 1002,
        clienteId: 2,
        cliente: 'Cliente Demo',
        productos: [
            { productoId: 2, nombre: 'iPhone 15 Pro', cantidad: 1, precio: 32999.99 },
            { productoId: 5, nombre: 'Sony WH-1000XM5', cantidad: 1, precio: 7999.99 }
        ],
        total: 40999.98,
        estado: 'en proceso',
        fecha: '2025-01-15',
...
function getOrders(filters = {}) {
    ...
    if (filters.clienteId) {
        orders = orders.filter(o => o.clienteId === parseInt(filters.clienteId));
    }
...
function getDashboardStats() {
    ...
    return {
        ...
        clientesActivos: users.filter(u => u.rol === 'cliente' && u.activo).length
    };
}
